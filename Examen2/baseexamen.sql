...
/****** Object:  Database [examen2]    Script Date: 11-Apr-20 8:06:16 PM ******/
CREATE DATABASE [examen2]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'examen2', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MILTONQS44\MSSQL\DATA\examen2.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'examen2_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.MILTONQS44\MSSQL\DATA\examen2_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [examen2] SET COMPATIBILITY_LEVEL = 140
GO
...
ALTER DATABASE [examen2] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [examen2] SET RECOVERY FULL 
GO
...
ALTER DATABASE [examen2] SET QUERY_STORE = OFF
GO
